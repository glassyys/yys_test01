## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /home/p190872/chksrc/test --mode SIMPLE
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /home/p190872/chksrc/test --mode DETAIL
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /home/p190872/chksrc/SIDHUB --mode DETAIL
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode SIMPLE
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode DETAIL
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode SIMPLE
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode SIMPLE
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode SIMPLE
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/SID --mode SIMPLE
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode DETAIL
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode DETAIL
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode DETAIL
## python3 /home/p190872/chksrc/sql_lng_005_with_t01.py /NAS/MIDP/DBMSVC/MIDP/SID --mode DETAIL
## GPT문의
#!/usr/bin/env python3
# sql_lng_005_with_t01.py
# 실행방법: python3 sql_lng_005_with_t01.py 소스디렉토리 [--mode SIMPLE|DETAIL]
...
# CREATE TEMPORARY/TEMP VIEW|TABLE 감지 (TEMP 레지스트리 수집용)
...
def build_rows(cte_map, sources_raw, targets, crud_type, sql_typ,
    ...
    DETAIL 모드:
      ① 물리소스 -> 최종타겟  (depth=1, CTE 투명 처리 행)
      ② 물리소스 -> CTE명     (depth=해당 CTE의 의존 단계)
      ③ CTE명   -> 최종타겟   (depth=해당 CTE depth + 1)
    """
    rows = []
    seen = set()
    ...
    # ② ③ DETAIL 추가 행 (CTE 있을 때만)
    if mode == "DETAIL" and cte_map and targets:

        # ② 물리소스 -> CTE명  (depth = CTE 의존 단계)
