## python3 /home/p190872/chksrc/sql_lng_013_with.py /home/p190872/chksrc/test --mode SIMPLE --db --conf /home/p190872/chksrc/mysql.conf
## python3 /home/p190872/chksrc/sql_lng_013_with.py /home/p190872/chksrc/test --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /home/p190872/chksrc/SIDHUB --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/SID --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_013_with.py /NAS/MIDP/DBMSVC/MIDP/SID --mode DETAIL --db
## 
...
## ■생성되는 테이블 예시
## 실행:
## python3 sql_lng_013_with.py /data/project1 --mode DETAIL --db
## 
## 생성 테이블명:
## sql_lng_013_with_project1_detail
## 아래 현재소스에서
...
#
# 실행방법:
# python3 sql_lng_013_with.py 소스디렉토리 [--mode SIMPLE|DETAIL] [--db] [--conf 경로]
#
# 옵션:
...
def parse_args():
    ...
    while i < len(args):
        if args[i] == "--mode":
            ...
            i += 1
    if src_dir is None:
        print("사용법: python3 sql_lng_013_with.py 절대경로포함소스디렉토리 "
