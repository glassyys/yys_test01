## python3 sql_est_srctgt_001.py /home/p190872/chksrc/SIDHUB
## python3 sql_est_srctgt_001.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB
## python3 sql_est_srctgt_001.py /NAS/MIDP/DBMSVC/MIDP/SID
## python3 sql_est_srctgt_001.py /NAS/MIDP/DBMSVC/MIDP/TMT
## python3 sql_est_srctgt_001.py /NAS/MIDP/DBMSVC/MIDP/TDIA
## python3 sql_est_srctgt_001.py /NAS/MIDP/DBMSVC/MIDP/TDM
## 파이썬으로 쿼리추출 소스코드 요청
## 1.추출 대상 확장자
## .sh
## .hql
