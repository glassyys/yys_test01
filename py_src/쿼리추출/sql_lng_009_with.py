## python3 /home/p190872/chksrc/sql_lng_009_with.py /home/p190872/chksrc/test --mode SIMPLE --db --conf /home/p190872/chksrc/mysql.conf
## python3 /home/p190872/chksrc/sql_lng_009_with.py /home/p190872/chksrc/test --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /home/p190872/chksrc/SIDHUB --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/SID --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_lng_009_with.py /NAS/MIDP/DBMSVC/MIDP/SID --mode DETAIL --db
## 
...
#
# 실행방법:
#   python3 sql_lng_009_with.py 소스디렉토리 [--mode SIMPLE|DETAIL] [--db] [--conf 경로]
#
# 옵션:
...
#                            (미지정 시 CSV 만 생성)
#   --conf 경로            : mysql.conf 파일 경로 지정(경로와파일명모두)
...
#   charset  = utf8mb4        # 선택 (기본값: utf8mb4)
#   # 참고
#   table은 선택사항이고 기본값은 sql_lineage
#   charset 선택사항이고 기본값은 utf8mb4
...
def db_insert_all(rows_buffer, run_id, mysql_conf):
    """
...
def parse_args():
    ...
    if src_dir is None:
        print("사용법: python3 sql_lng_007_with.py 절대경로포함소스디렉토리 "
...
def main():
    ...
    if USE_DB and mysql_conf:
        db_inserted, db_err_msg = db_insert_all(rows_buffer, timestamp, mysql_conf)
    ...
    if USE_DB:
        ...
        if db_err_msg:
            ...
            print(f"DB 등록 결과    : 성공")
            print(f"DB 등록 테이블  : {mysql_conf.get('database')}.{tbl}")
