## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /home/p190872/chksrc/test --mode SIMPLE --db --conf /home/p190872/chksrc/mysql.conf
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /home/p190872/chksrc/test --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /home/p190872/chksrc/SIDHUB --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/SID --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full.py /NAS/MIDP/DBMSVC/MIDP/SID --mode DETAIL --db
## 
...
#!/usr/bin/env python3
# ===============================================================
# sql_tb_chk_v09_full.py
#
# 실행예시:
#   python3 sql_tb_chk_v09_full.py <분석대상_디렉토리>
...
def parse_args():
    ...
    if src_dir is None:
        print("사용법: python3 sql_tb_chk_v09_full.py 소스디렉토리 "
              "[--mode SIMPLE|DETAIL] [--db] [--conf 경로]")
        sys.exit(1)
...
def main():
    ...
    if USE_DB:
        ...
        print(f"[INFO] 등록 테이블     : {table_name}")
        print("=" * 60)
