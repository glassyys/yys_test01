## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /home/p190872/chksrc/test --mode SIMPLE --db --conf /home/p190872/chksrc/mysql.conf
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /home/p190872/chksrc/test --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /home/p190872/chksrc/SIDHUB --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/SID/SRC/SIDHUB --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/TMT --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/TDIA --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/TDM --mode DETAIL --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/SID --mode SIMPLE --db
## python3 /home/p190872/chksrc/sql_tb_chk_v09_full_text.py /NAS/MIDP/DBMSVC/MIDP/SID --mode DETAIL --db
## 
...
#!/usr/bin/env python3
# ===============================================================
# sql_tb_chk_v09_full_text.py
#
# 실행예시:
#   python3 sql_tb_chk_v09_full_text.py <분석대상_디렉토리>
...
def parse_args():
    ...
    if src_dir is None:
        print("사용법: python3 sql_tb_chk_v09_full_text.py 소스디렉토리 "
              "[--mode SIMPLE|DETAIL] [--db] [--conf 경로]")
        sys.exit(1)
...
def extract_queries_from_file(file_path: str) -> tuple:
    ...
    try:
        ...
        # 원본(raw)도 같은 offset 기반으로 잘라내기 위해
        # masked 와 raw 는 길이가 다를 수 있으므로
        # preprocessed 쿼리를 그대로 raw_query 로 사용한다.
        # (원본 주석 포함 버전을 원하면 별도 offset 매핑 필요)
            ...
            if query:
                ...
                if keyword.upper().startswith("ALTER") and \
                   not re.match(r"ALTER\s+(TABLE|VIEW)\b", query, re.IGNORECASE):
                    pos = end
                    continue
                # raw_query: 전처리된(주석 제거) 텍스트를 원본 쿼리로 저장
                queries_with_raw.append((query, query))
            pos = end

        # EXECUTE IMMEDIATE 내부 쿼리 추가 (raw = preprocessed)
...
def compute_cte_depths(cte_map: dict) -> dict:
    ...
    def get_depth(cte_name, visiting=None):
        ...
        depth_map[cte_name] = (max(get_depth(d, visiting) for d in deps) + 1
                               if deps else 1)
        return depth_map[cte_name]
